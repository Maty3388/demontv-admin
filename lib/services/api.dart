...
class AdminApi {
  ...
  static Future<Map<String, dynamic>> createClient(String email, String pass, int months, bool useExtras) =>
      _post('/admin/clients', {'email': email, 'password': pass, 'months': months, 'useExtras': useExtras});
  ...
  static Future<Map<String, dynamic>> verifyStream(String url) =>
      _post('/admin/channels/verify', {'url': url});
